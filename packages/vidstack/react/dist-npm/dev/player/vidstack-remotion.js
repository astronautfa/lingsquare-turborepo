...
import { createDisposalBin, animationFrameThrottle, noop } from '../chunks/vidstack-3hs3-8i_.js';
import { Internals, random } from 'remotion';
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-Dw0Lpul5.js';
export { isRemotionProvider } from '../chunks/vidstack-Dw0Lpul5.js';
import { RemotionThumbnail as RemotionThumbnail$1, RemotionSliderThumbnail as RemotionSliderThumbnail$1, RemotionPoster as RemotionPoster$1 } from '../chunks/vidstack-BVbKfF2_.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-CwMhfkJZ.js')).RemotionProvider(this.target, ctx);
  }
}
