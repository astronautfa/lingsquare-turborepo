...
import { useMediaState, usePlyrLayoutClasses, Primitive, IS_SERVER, isRemotionSrc, getDownloadFile } from '../chunks/vidstack-Dw0Lpul5.js';
import * as React from 'react';
import { uppercaseFirstChar, isUndefined, signal, composeRefs, useSignal, isNumber, listenEvent, isKeyboardEvent, isKeyboardClick } from '../chunks/vidstack-3hs3-8i_.js';
import { useMediaContext, PlayButton, Root, Img, Gesture, AirPlayButton, CaptionButton, FullscreenButton, PIPButton, SeekButton, Root$1, Value, Preview, Thumbnail, LiveButton, Time, Root$2, Button, Items, useAudioOptions, Root$3, Item, useCaptionOptions, MuteButton, Root$4 } from '../chunks/vidstack-8ISOe38A.js';
import { useMediaRemote, usePlaybackRateOptions, useVideoQualityOptions } from '../chunks/vidstack-DoXNQJv3.js';
import { useLayoutName, useClassName } from '../chunks/vidstack-CtnLOtjb.js';
import { RemotionThumbnail, RemotionPoster, RemotionSliderThumbnail } from '../chunks/vidstack-BVbKfF2_.js';
