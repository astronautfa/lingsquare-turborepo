...
import { l as listen, d as IS_CHROME, e as IS_IOS, f as canGoogleCastSrc, I as IS_SERVER, g as loadScript } from './vidstack-DLTRlLRp.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-CwGY6jjM.js')).GoogleCastProvider(this._player, ctx);
  }
