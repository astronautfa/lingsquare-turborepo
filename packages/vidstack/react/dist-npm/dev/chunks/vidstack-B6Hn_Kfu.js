...
import { listen, IS_CHROME, IS_IOS, canGoogleCastSrc, IS_SERVER, loadScript } from './vidstack-Dw0Lpul5.js';
import { peek } from './vidstack-3hs3-8i_.js';
...
class GoogleCastLoader {
  ...
  async load(ctx) {
    ...
    return new (await import('./vidstack-Ducpk2WM.js')).GoogleCastProvider(this._player, ctx);
  }
