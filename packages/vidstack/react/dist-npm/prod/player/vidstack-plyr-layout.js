...
import { useMediaState, usePlyrLayoutClasses, Primitive, IS_SERVER, isRemotionSrc, getDownloadFile } from '../chunks/vidstack-DVfG6VuV.js';
import * as React from 'react';
import { uppercaseFirstChar, isUndefined, signal, composeRefs, useSignal, isNumber, listenEvent, isKeyboardEvent, isKeyboardClick } from '../chunks/vidstack-DcuYVyd0.js';
import { useMediaContext, PlayButton, Root, Img, Gesture, AirPlayButton, CaptionButton, FullscreenButton, PIPButton, SeekButton, Root$1, Value, Preview, Thumbnail, LiveButton, Time, Root$2, Button, Items, useAudioOptions, Root$3, Item, useCaptionOptions, MuteButton, Root$4 } from '../chunks/vidstack-C0BKR3Mz.js';
import { useMediaRemote, usePlaybackRateOptions, useVideoQualityOptions } from '../chunks/vidstack-5MgWDcgW.js';
import { useLayoutName, useClassName } from '../chunks/vidstack-C_oXuBVD.js';
import { RemotionThumbnail, RemotionPoster, RemotionSliderThumbnail } from '../chunks/vidstack-5ezil3Mm.js';
