...
function MediaOutlet({ provider, mediaProps, iframeProps }) {
  ...
  React.useEffect(() => {
    ...
    import('./chunks/vidstack-DcuYVyd0.js').then(function (n) { return n.chromecast; }).then((mod) => {
