...
import { createDisposalBin, listenEvent, createScope, signal, useSignal, tick, peek, effect, isFunction, deferredPromise } from './vidstack-DcuYVyd0.js';
import { Internals } from 'remotion';
import { isRemotionSrc, TimeRange } from './vidstack-DVfG6VuV.js';
import { RemotionLayoutEngine, RemotionContextProvider, ErrorBoundary, REMOTION_PROVIDER_ID } from '../player/vidstack-remotion.js';
import { NoReactInternals } from 'remotion/no-react';
import '@floating-ui/dom';
import './vidstack-5ezil3Mm.js';
...
class RemotionProvider {
  ...
  Hn() {
    ...
    for (const el of this._m) {
      if (!elements.includes(el)) this.vn(el);
    }
  }
  en(frame) {
