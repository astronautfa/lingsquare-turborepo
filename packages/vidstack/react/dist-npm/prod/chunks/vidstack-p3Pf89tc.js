...
import { createScope, signal, effect, peek, isString, deferredPromise, listenEvent, isArray } from './vidstack-DcuYVyd0.js';
import { TimeRange, RAFLoop, preconnect, ListSymbol, TextTrack, QualitySymbol } from './vidstack-DVfG6VuV.js';
...
class VimeoProvider extends EmbedProvider {
  constructor(iframe, _ctx) {
    ...
    this.fullscreen = {
      ...
      supported: true,
      enter: () => this.u("requestFullscreen"),
      exit: () => this.u("exitFullscreen")
    };
  }
  get c() {
