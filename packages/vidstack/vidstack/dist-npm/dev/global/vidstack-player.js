...
import { isString, defineCustomElement, kebabToCamelCase } from '../chunks/vidstack-fG_Sx3Q9.js';
import { isHTMLAudioElement, isHTMLVideoElement, isHTMLIFrameElement } from '../chunks/vidstack-BYGViWgv.js';
  ...
  static async create({ target, layout, tracks, ...props }) {
    ...
    if (props.poster && layout?.name !== "plyr") {
      if (!customElements.get("media-poster")) {
        const { MediaPosterElement } = await import('../chunks/vidstack-DoWf48SK.js');
