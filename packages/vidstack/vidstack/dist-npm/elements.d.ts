...
import { n as MaverickElementConstructor, A as Attributes, l as Component, T as TemplateResult, R as ReadSignal } from './types/vidstack-r3TSzzgs.js';
export { o as defineCustomElement } from './types/vidstack-r3TSzzgs.js';
import { ih as Captions, i7 as Gesture, fA as MediaProvider, M as MediaPlayerProps, fx as MediaPlayer, fB as MediaAnnouncer, ii as PosterProps, ik as Poster, ip as ThumbnailProps, o as MediaContext, t as Thumbnail, il as Time, fH as Controls, fL as ControlsGroup, cb as MediaPlayerQuery, D as DefaultLayoutProps, iA as PlyrLayout, fY as AirPlayButton, g5 as CaptionButton, g8 as FullscreenButton, f$ as GoogleCastButton, gk as LiveButton, gb as MuteButton, ge as PIPButton, g2 as PlayButton, gh as SeekButton, fV as ToggleButton, fU as ToggleButtonProps, fM as Tooltip, fO as TooltipTrigger, fP as TooltipContent, hK as AudioRadioGroup, hU as CaptionsRadioGroup, hc as Menu, hh as MenuButton, hn as MenuPortalProps, hm as MenuPortal, hl as MenuItem, hq as MenuItems, hF as ChaptersRadioGroup, h_ as SpeedRadioGroup, hQ as AudioGainRadioGroup, i2 as QualityRadioGroup, hz as Radio, hv as RadioGroup, gw as Slider, gI as SliderValueProps, gH as SliderValue, gB as SliderVideo, h4 as TimeSlider, gJ as SliderPreview, gM as VolumeSlider, gR as AudioGainSlider, gW as SpeedSlider, g$ as QualitySlider, h9 as SliderChapters } from './types/vidstack-CB8Klup7.js';
...
declare class DefaultLayout extends Component<DefaultLayoutProps> {
    ...
    protected _media: MediaContext;
    protected _when: ReadSignal<boolean>;
    protected _smallWhen: ReadSignal<boolean>;
    get isMatch(): boolean;
