...
import { q as computed, f as signal, g as effect, p as peek, l as listenEvent, U as isKeyboardEvent, B as isKeyboardClick, H as Host, r as onDispose } from '../chunks/vidstack-CBNXqr3M.js';
import { a as usePlyrLayoutContext, u as usePlyrLayoutClasses, P as PlyrLayout } from '../chunks/vidstack-DuqfpSxk.js';
import { u as useMediaContext } from '../chunks/vidstack-DoOTQiYD.js';
import { L as LayoutIconsLoader, I as Icon, $ as $signal, S as SlotManager } from '../chunks/vidstack-_f_0FzgB.js';
import { L as LitElement } from '../chunks/vidstack-rsZGrNIW.js';
import { g as getDownloadFile } from '../chunks/vidstack-BTmcG2zk.js';
...
function TimeSlider() {
  let media = useMediaContext(), { duration, viewType } = media.$state, { translations, markers, thumbnails, seekTime, previewTime } = usePlyrLayoutContext(), $seekText = $i18n(translations, "Seek"), activeMarker = signal(null), $markerLabel = $signal(() => {
    ...
    return marker ? x`<span class="plyr__progress__marker-label">${o(marker.label)}<br /></span>` : null;
  });
...
function Captions() {
  const media = useMediaContext(), activeCue = signal(void 0), $cueText = $signal(() => o(activeCue()?.text));
  effect(() => {
...
class MediaPlyrLayoutElement extends Host(LitElement, PlyrLayout) {
  static {
    this.tagName = "media-plyr-layout";
  }
  onSetup() {
  ...
  onConnect() {
    this.a.player.el?.setAttribute("data-layout", "plyr");
