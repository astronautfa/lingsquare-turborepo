...
var t, i, s2, e, o, n, l, h2, r, u, d2, c, v, a, f, _, m2, p, g, $, y, w, x, b, T, A, E, C, V, N, M, R, k, H, I, L, z, Z, j, B, D;
var init_lit_html = __esm({
  "../../../node_modules/.pnpm/lit-html@2.8.0/node_modules/lit-html/lit-html.js"() {
    i = window;
    s2 = i.trustedTypes;
    e = s2 ? s2.createPolicy("lit-html", { createHTML: (t5) => t5 }) : void 0;
    o = "$lit$";
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
    ...
    V = (t5, i4) => {
      ...
      for (let i5 = 0; i5 < s5; i5++) {
        ...
        r4 += u2 === f ? s6 + h2 : v2 >= 0 ? (e6.push(d3), s6.slice(0, v2) + o + s6.slice(v2) + n + w2) : s6 + n + (-2 === v2 ? (e6.push(void 0), i5) : w2);
      }
      ...
      constructor({ strings: t5, _$litType$: i4 }, e6) {
        ...
        for (; null !== (h5 = C.nextNode()) && v2.length < c3; ) {
          if (1 === h5.nodeType) {
            if (h5.hasAttributes()) {
              const t6 = [];
              for (const i5 of h5.getAttributeNames()) if (i5.endsWith(o) || i5.startsWith(n)) {
                const s5 = f2[d3++];
                if (t6.push(i5), void 0 !== s5) {
                  const t7 = h5.getAttribute(s5.toLowerCase() + o).split(n), i6 = /([.?@])?(.*)/.exec(s5);
            ...
            if (y.test(h5.tagName)) {
              const t6 = h5.textContent.split(n), i5 = t6.length - 1;
              if (i5 > 0) {
          ...
          } else if (8 === h5.nodeType) if (h5.data === l) v2.push({ type: 2, index: r4 });
          else {
            let t6 = -1;
            for (; -1 !== (t6 = h5.data.indexOf(n, t6 + 1)); ) v2.push({ type: 7, index: r4 }), t6 += n.length - 1;
          }
          r4++;
        }
      }
    ...
    M = class {
      ...
      u(t5) {
        var i4;
        const { el: { content: s5 }, parts: e6 } = this._$AD, o6 = (null !== (i4 = null == t5 ? void 0 : t5.creationScope) && void 0 !== i4 ? i4 : r).importNode(s5, true);
        C.currentNode = o6;
...
function h3(i4, t5 = false, e6 = 0) {
  ...
  if (void 0 !== n5 && 0 !== n5.size) if (t5) if (Array.isArray(r4)) for (let i5 = e6; i5 < r4.length; i5++) s4(r4[i5], false), o2(r4[i5]);
  else null != r4 && (s4(r4, false), o2(r4));
  else s4(this, i4);
}
var s4, o2, r2, l3, c2;
var init_async_directive = __esm({
  "../../../node_modules/.pnpm/lit-html@2.8.0/node_modules/lit-html/async-directive.js"() {
    ...
    l3 = (i4) => {
      var t5, s5, o6, r4;
      i4.type == t2.CHILD && (null !== (t5 = (o6 = i4)._$AP) && void 0 !== t5 || (o6._$AP = h3), null !== (s5 = (r4 = i4)._$AQ) && void 0 !== s5 || (r4._$AQ = n2));
    };
    c2 = class extends i2 {
      constructor() {
      ...
      _$AT(i4, t5, e6) {
        super._$AT(i4, t5, e6), r2(this), this.isConnected = i4._$AU;
      }
      _$AO(i4, t5 = true) {
        var e6, r4;
        i4 !== this.isConnected && (this.isConnected = i4, i4 ? null === (e6 = this.reconnected) || void 0 === e6 || e6.call(this) : null === (r4 = this.disconnected) || void 0 === r4 || r4.call(this)), t5 && (s4(this, i4), o2(this));
      }
      setValue(t5) {
...
function DefaultVolumePopup({
  ...
  return $signal(() => {
    ...
    return x`
      <div class="vds-volume" ?data-active=${$signal($isRootActive)} ${n3($rootRef.set)}>
...
function DefaultAudioTitle() {
  return $signal(() => {
    ...
    return title() ? x`
          <span class="vds-title" title=${$signal($title)} ${n3($ref.set)}>
            ${[
      Title2(),
...
var init_unsafe_html = __esm({
  "../../../node_modules/.pnpm/lit-html@2.8.0/node_modules/lit-html/directives/unsafe-html.js"() {
    ...
    e4 = class extends i2 {
      constructor(i4) {
        if (super(i4), this.et = A, i4.type !== t2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
      }
      render(r4) {
...
var t4, e5, n4, o5, l5, r3;
var init_dist = __esm({
  "../../../node_modules/.pnpm/compute-scroll-into-view@3.1.0/node_modules/compute-scroll-into-view/dist/index.js"() {
    t4 = (t5) => "object" == typeof t5 && null != t5 && 1 === t5.nodeType;
    e5 = (t5, e6) => (!e6 || "hidden" !== t5) && ("visible" !== t5 && "clip" !== t5);
    n4 = (t5, n5) => {
      if (t5.clientHeight < t5.scrollHeight || t5.clientWidth < t5.scrollWidth) {
        const o6 = getComputedStyle(t5, null);
        return e5(o6.overflowY, n5) || e5(o6.overflowX, n5) || ((t6) => {
          const e6 = ((t7) => {
    ...
    o5 = (t5, e6, n5, o6, l6, r4, i4, s5) => r4 < t5 && i4 > e6 || r4 > t5 && i4 < e6 ? 0 : r4 <= t5 && s5 <= n5 || i4 >= e6 && s5 >= n5 ? r4 - t5 - o6 : i4 > e6 && s5 < n5 || r4 < t5 && s5 > n5 ? i4 - e6 + l6 : 0;
    l5 = (t5) => {
    ...
    r3 = (e6, r4) => {
      ...
      for (; t4(W) && p2(W); ) {
        ...
        null != W && W === document.body && n4(W) && !n4(document.documentElement) || null != W && n4(W, g2) && w2.push(W);
      }
      ...
      for (let t5 = 0; t5 < w2.length; t5++) {
        ...
        if (m3 === e7) T3 = "start" === f2 ? k2 : "end" === f2 ? k2 - H2 : "nearest" === f2 ? o5(M2, M2 + H2, H2, g3, W2, M2 + k2, M2 + k2 + v2, v2) : k2 - H2 / 2, B3 = "start" === u2 ? D2 : "center" === u2 ? D2 - b2 / 2 : "end" === u2 ? D2 - b2 : o5(y2, y2 + b2, b2, a4, p3, y2 + D2, y2 + D2 + E2, E2), T3 = Math.max(0, T3 + M2), B3 = Math.max(0, B3 + y2);
        else {
          T3 = "start" === f2 ? k2 - r5 - g3 : "end" === f2 ? k2 - s6 + W2 + V3 : "nearest" === f2 ? o5(r5, s6, n5, g3, W2 + V3, k2, k2 + v2, v2) : k2 - (r5 + n5 / 2) + V3 / 2, B3 = "start" === u2 ? D2 - d4 - a4 : "center" === u2 ? D2 - (d4 + l6 / 2) + F2 / 2 : "end" === u2 ? D2 - i5 + p3 + F2 : o5(d4, i5, l6, a4, p3 + F2, D2, D2 + E2, E2);
...
var MenuPortal2, menuPortalContext;
