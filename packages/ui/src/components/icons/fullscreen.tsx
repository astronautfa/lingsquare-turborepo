...
const EnterFullScreenRegular = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
    ({ className, ...props }, ref) => (
        <svg ref={ref}
...
const EnterFullScreenSolid = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
    ({ className, ...props }, ref) => (
        <svg
            className={cn(className)}
            fill="currentColor" stroke="currentColor"
...
EnterFullScreenRegular.displayName = "EnterFullScreenRegular";
EnterFullScreenSolid.displayName = "EnterFullScreenSolid";

const ExitFullScreenRegular = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
    ({ className, ...props }, ref) => (
        <svg ref={ref}
            className={cn(className)}
            fill="currentColor" stroke="currentColor"
...
const ExitFullScreenSolid = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
    ({ className, ...props }, ref) => (
        <svg
            className={cn(className)}
            fill="currentColor" stroke="currentColor"
...
ExitFullScreenRegular.displayName = "ExitFullScreenRegular";
ExitFullScreenSolid.displayName = "ExitFullScreenSolid";

export { EnterFullScreenRegular, EnterFullScreenSolid, ExitFullScreenRegular, ExitFullScreenSolid };
