...
import { i as isString, d as defineCustomElement, k as kebabToCamelCase } from '../chunks/vidstack-CBNXqr3M.js';
  ...
  static async create({ target, layout, tracks, ...props }) {
    ...
    if (props.poster && layout?.name !== "plyr") {
      if (!customElements.get("media-poster")) {
        const { MediaPosterElement } = await import('../chunks/vidstack-BuXAfxgW.js');
