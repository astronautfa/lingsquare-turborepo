...
import type { MediaProviderLoader } from '../../providers/types.js';
import type { VideoQuality } from '../quality/video-quality.js';
import type { AudioTrack } from '../tracks/audio-tracks.js';
import { type TextTrack } from '../tracks/text/text-track.js';
import type { Src } from './src-types.js';
import type { MediaCrossOrigin, MediaErrorDetail, MediaStreamType, MediaType, MediaViewType, RemotePlaybackInfo, RemotePlaybackType } from './types.js';
export interface MediaPlayerState extends MediaState {
}
export declare const mediaState: State<MediaState>;
/**
 * Resets all media state and leaves general player state intact.
 */
export declare function softResetMediaState($media: MediaStore, isSourceQualityChange?: boolean): void;
