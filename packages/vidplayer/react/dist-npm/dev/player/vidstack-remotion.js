...
import { I as IS_SERVER, u as useMediaState, m as isRemotionSrc, P as Primitive, q as useSliderState } from '../chunks/vidstack-DLTRlLRp.js';
export { r as isRemotionProvider } from '../chunks/vidstack-DLTRlLRp.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-Z2RYIsVS.js')).RemotionProvider(this.target, ctx);
  }
}
