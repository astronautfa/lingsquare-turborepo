...
import { I as IS_SERVER, u as useMediaState, m as isRemotionSrc, P as Primitive, q as useSliderState } from '../chunks/vidstack-1EoJRWh6.js';
export { r as isRemotionProvider } from '../chunks/vidstack-1EoJRWh6.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-CVqG0ZC4.js')).RemotionProvider(this.target, ctx);
  }
}
