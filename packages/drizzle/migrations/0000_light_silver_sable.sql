...
CREATE INDEX IF NOT EXISTS "password_token_user_idx" ON "app_password_reset_tokens" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "user_discord_idx" ON "app_users" USING btree ("discord_id");