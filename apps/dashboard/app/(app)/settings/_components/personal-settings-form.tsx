...
type PersonalSettingsFormValues = z.infer<typeof personalSettingsFormSchema>

// This can come from your database or API.
const defaultValues: Partial<PersonalSettingsFormValues> = {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="alireza" {...field} />
              </FormControl>
              <FormDescription>
